<template>
  <div class="car-card" @click="viewCarDetail">
    ...
    <div class="car-info">
      <h2 class="car-title">{{ car.modelName }}</h2>
      <p class="car-subtitle">{{ car.emissionStandard }}</p>
      <h2 class="car-title">{{ car.fullTitle }}</h2>
      <div class="car-meta">
        <van-icon name="clock-o" size="14" />
        <span>{{ car.firstRegTime }}</span>
...
<script setup>
import { fetchCarDetail } from '@/api/base/index.js'
